...
cd /tmp
git clone --depth 1 --branch "v1.0.0-beta.16" https://github.com/virtuosoft-dev/hestiacp-pluginable.git 2>/dev/null
...
git clone --depth 1 --branch "v1.0.0-beta.8" https://github.com/virtuosoft-dev/hcpp-nodeapp.git nodeapp 2>/dev/null
...
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.1" https://github.com/virtuosoft-dev/hcpp-nodered.git nodered 2>/dev/null
...
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.0-beta.4" https://github.com/virtuosoft-dev/hcpp-mailcatcher.git mailcatcher 2>/dev/null
...
# Install HCPP NodeBB
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.0-beta.4" https://github.com/virtuosoft-dev/hcpp-nodebb.git nodebb 2>/dev/null
...
# Install HCPP Ghost
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.0-beta.2" https://github.com/virtuosoft-dev/hcpp-ghost.git ghost 2>/dev/null
...
# Install HCPP CG-PWS
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.0-beta.2" https://github.com/virtuosoft-dev/hcpp-cg-pws.git cg-pws 2>/dev/null
