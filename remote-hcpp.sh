...
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.0.12" https://github.com/devstia/hcpp-quickstart.git quickstart
...
# Install HCPP VSCode
cd /usr/local/hestia/plugins
git clone --depth 1 --branch "v1.1.1" https://github.com/virtuosoft-dev/hcpp-vscode.git vscode
