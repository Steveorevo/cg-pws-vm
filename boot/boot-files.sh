...
# we've already included them (compressed; tar.xz) in the repo
# for convenience. Use this script on a Ubuntu/Debian instance
# of QEMU + EFI to update/obtain the files if needed.
#
